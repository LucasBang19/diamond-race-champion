...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "int.b6.period.end": { pt: "Término: Sem data definida. Apenas quando atingir 460 novos alunos pagos na Comunidade SMA, via afiliação (acompanhe o termômetro da meta em tempo real nesta página)", es: "Término: Sin fecha definida. Solo cuando alcance 460 nuevos alumnos pagos en la Comunidad SMA, vía afiliación (acompaña el termómetro de la meta en tiempo real en esta página)" },
  "int.b6.bmw.title": { pt: "CONDIÇÃO PARA A ENTREGA DA BMW", es: "CONDICIÓN PARA LA ENTREGA DEL BMW" },
  "int.b6.bmw.desc": { pt: "A BMW e demais prêmios só serão entregues quando a meta de 460 novos alunos pagos na Comunidade for alcançada.", es: "El BMW y demás premios solo se entregarán cuando la meta de 460 nuevos alumnos pagos en la Comunidad sea alcanzada." },
