    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="section-dark relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-3 sm:px-4 pt-10 sm:pt-16 pb-8 text-center">
          <p className="text-gold font-body text-sm sm:text-base font-bold uppercase tracking-[0.2em] mb-4 animate-fade-up">
            {t("int.hero.badge")}
          </p>
          ...
          <p className="font-body text-base sm:text-lg max-w-2xl mx-auto mb-2" style={{ color: "hsl(0 0% 70%)" }}>
            {t("int.hero.sub1")}
          </p>
          <p className="font-body text-base sm:text-lg max-w-2xl mx-auto mb-6" style={{ color: "hsl(0 0% 70%)" }}>
            {t("int.hero.sub2")}
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 max-w-3xl mx-auto mb-8">
            <div className="prize-card">
              ...
              <p className="text-sm font-bold uppercase tracking-wide text-gold">1º</p>
              <p className="text-base font-bold mt-1" style={{ color: "hsl(0 0% 90%)" }}>BMW 320i</p>
            </div>
            <div className="prize-card">
              <Laptop className="mx-auto mb-2 text-gold" size={28} />
              <p className="text-sm font-bold uppercase tracking-wide text-gold">2º</p>
              <p className="text-base font-bold mt-1" style={{ color: "hsl(0 0% 90%)" }}>MacBook Pro</p>
            </div>
            <div className="prize-card">
              <Smartphone className="mx-auto mb-2 text-gold" size={28} />
              <p className="text-sm font-bold uppercase tracking-wide text-gold">3º</p>
              <p className="text-base font-bold mt-1" style={{ color: "hsl(0 0% 90%)" }}>iPhone</p>
            </div>
            <div className="prize-card">
              <Palmtree className="mx-auto mb-2 text-gold" size={28} />
              <p className="text-sm font-bold uppercase tracking-wide text-gold">4º e 5º</p>
              <p className="text-base font-bold mt-1" style={{ color: "hsl(0 0% 90%)" }}>Resort Pago</p>
            </div>
          </div>

          <p className="text-gold font-bold text-base uppercase tracking-wide mb-3">{t("int.hero.support")}</p>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="max-w-xl mx-auto mb-6">
            <div className="flex justify-between text-sm font-bold mb-2">
              <span className="text-muted-foreground">{CURRENT_STUDENTS} alunos</span>
              <span className="text-gold">{GOAL} alunos</span>
            </div>
      ...
      <section className="section-dark py-12 sm:py-20 px-3 sm:px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="font-body text-base mb-2" style={{ color: "hsl(0 0% 70%)" }}>{t("int.b3.desc")}</p>
          <p className="font-body text-base mb-8" style={{ color: "hsl(0 0% 70%)" }}>{t("int.b3.sub")}</p>
          ...
          <div className="border border-border rounded-sm p-12" style={{ borderColor: "hsl(43 75% 49% / 0.2)" }}>
            ...
            <p className="text-gold font-bold text-base uppercase tracking-wide">{t("int.b3.soon")}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-20 px-3 sm:px-4 bg-background">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gold font-bold text-base uppercase tracking-wide">{t("int.b4.layers")}</p>
          </div>
          ...
          <Accordion type="multiple" className="space-y-3">
            ...
            <AccordionItem value="camada1" className="border border-border rounded-sm overflow-hidden" style={{ borderColor: "hsl(43 75% 49% / 0.3)" }}>
              ...
              <AccordionContent className="px-4 sm:px-6">
                <p className="text-base text-muted-foreground mb-3">{t("int.c1.desc")}</p>
                <p className="text-sm text-muted-foreground mb-4 italic">{t("int.c1.obs")}</p>
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  {[
                    ...
                    <div key={item.label} className="border border-border rounded-sm p-3 text-center" style={{ borderColor: "hsl(43 75% 49% / 0.2)" }}>
                      <p className="text-sm font-bold mb-1 leading-tight">{item.label}</p>
                ...
                <div className="bg-muted/30 rounded-sm p-3 mb-3">
                  <p className="text-sm font-bold text-gold mb-1">{t("int.c1.important")}</p>
                </div>
                <div className="bg-muted/30 rounded-sm p-3 mb-3">
                  <p className="text-sm font-bold mb-1">{t("int.c1.proof.title")}</p>
                  <p className="text-sm text-muted-foreground">{t("int.c1.proof.desc")}</p>
                </div>
                <p className="text-sm text-muted-foreground mb-1">{t("int.c1.affiliate")}</p>
                <p className="text-sm text-muted-foreground">{t("int.c1.affiliate.bonus")}</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="camada2" className="border border-border rounded-sm overflow-hidden" style={{ borderColor: "hsl(43 75% 49% / 0.3)" }}>
              ...
              <AccordionContent className="px-4 sm:px-6">
                <p className="text-base text-muted-foreground mb-3">{t("int.c2.desc")}</p>
                <p className="text-sm font-bold mb-1">{t("int.c2.sub")}</p>
                <p className="text-sm text-muted-foreground mb-3">{t("int.c2.sub.desc")}</p>
                <p className="text-sm text-muted-foreground mb-3">{t("int.c2.pts.label")}</p>
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  {[
                    ...
                    <div key={item.label} className="border border-border rounded-sm p-3 text-center" style={{ borderColor: "hsl(43 75% 49% / 0.2)" }}>
                      <p className="text-sm font-bold mb-1 leading-tight">{item.label}</p>
                      <p className="text-gold font-black text-xl">{item.pts}</p>
                      <p className="text-sm text-muted-foreground">PONTOS/VENDA</p>
                    </div>
                  ))}
                </div>

                <div className="bg-muted/30 rounded-sm p-3 mb-3">
                  <p className="text-sm font-bold mb-1">{t("int.c2.rules.title")}</p>
                ...
                <div className="bg-muted/30 rounded-sm p-3 mb-4">
                  <p className="text-sm font-bold mb-1">{t("int.c2.proof.title")}</p>
                  <p className="text-sm text-muted-foreground">{t("int.c2.proof.desc")}</p>
                </div>

                {/* Bônus faturamento */}
                <div className="border-t border-border pt-4 mt-4">
                  <p className="font-heading text-base font-bold mb-3">{t("int.c2.bonus.title")}</p>
                  <p className="text-sm text-muted-foreground mb-3">{t("int.c2.bonus.desc")}</p>
                  <div className="space-y-2 mb-3">
                    {[
                      ...
                      <div key={b.range} className="flex justify-between items-center border border-border rounded-sm px-4 py-2" style={{ borderColor: "hsl(43 75% 49% / 0.15)" }}>
                        <span className="text-sm font-bold">Acima de {b.range}</span>
                        <span className="text-gold font-black text-base">{b.pts} pts</span>
                      </div>
                    ))}
                  </div>
                  <p className="text-sm text-muted-foreground mb-1">{t("int.c2.bonus.cumulative")}</p>
                  <p className="text-sm text-muted-foreground mb-3">{t("int.c2.bonus.refund")}</p>
                  <div className="bg-muted/30 rounded-sm p-3">
                    <p className="text-sm font-bold mb-1">{t("int.c2.bonus.proof.title")}</p>
                    <p className="text-sm text-muted-foreground">{t("int.c2.bonus.proof.desc")}</p>
                  </div>
                </div>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="camada3" className="border border-border rounded-sm overflow-hidden" style={{ borderColor: "hsl(43 75% 49% / 0.3)" }}>
              ...
              <AccordionContent className="px-4 sm:px-6">
                <p className="text-base text-muted-foreground mb-2">{t("int.c3.desc")}</p>
                <p className="text-sm text-muted-foreground mb-2 italic">{t("int.c3.products")}</p>
                <p className="text-sm text-muted-foreground mb-4">{t("int.c3.more")}</p>
                ...
                <div className="bg-muted/30 rounded-sm p-3 mb-3">
                  <p className="text-sm font-bold text-destructive mb-1">{t("int.c3.exit.warning")}</p>
                  <p className="text-sm text-muted-foreground">{t("int.c3.exit.example")}</p>
                </div>
                <div className="bg-muted/30 rounded-sm p-3 mb-4">
                  <p className="text-sm font-bold mb-1">{t("int.c3.proof.title")}</p>
                  <p className="text-sm text-muted-foreground">{t("int.c3.proof.desc")}</p>
                </div>

                {/* Avanço */}
                <div className="border-t border-border pt-4 mt-4">
                  <p className="font-heading text-base font-bold mb-3">{t("int.c3.advance.title")}</p>
                  <p className="text-sm text-muted-foreground mb-3">{t("int.c3.advance.desc")}</p>
                  <div className="space-y-2 mb-3">
                    {[
                      ...
                      <div key={a.path} className="flex justify-between items-center border border-border rounded-sm px-4 py-2" style={{ borderColor: "hsl(43 75% 49% / 0.15)" }}>
                        <span className="text-sm font-bold">{a.path}</span>
                        <span className="text-gold font-black text-base">{a.pts} pts</span>
                      </div>
                    ))}
                  </div>
                  <p className="text-sm text-muted-foreground mb-3">{t("int.c3.advance.note")}</p>
                  <p className="text-sm text-muted-foreground mb-2">{t("int.c3.advance.proof")}</p>
                  <a href={WPP_LINK} target="_blank" rel="noopener noreferrer" className="text-gold text-sm font-bold underline">
                ...
                {/* Ativação ferramenta */}
                <div className="border-t border-border pt-4 mt-4">
                  <p className="font-heading text-base font-bold mb-3">{t("int.c3.tool.title")}</p>
                  <div className="space-y-2 mb-3">
                    {[
                      ...
                      <div key={tool.name} className="flex justify-between items-center border border-border rounded-sm px-4 py-2" style={{ borderColor: "hsl(43 75% 49% / 0.15)" }}>
                        ...
                        <span className="text-gold font-black text-base">{tool.pts} pts</span>
                      </div>
                    ))}
                  </div>
                  <p className="text-sm text-muted-foreground mb-3">{t("int.c3.tool.proof")}</p>
                  <div className="bg-muted/30 rounded-sm p-3">
                    <p className="text-sm font-bold text-gold mb-1">{t("int.c3.email.warning")}</p>
                    <p className="text-sm text-muted-foreground">{t("int.c3.email.change")}</p>
                  </div>
                </div>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="camada4" className="border border-border rounded-sm overflow-hidden" style={{ borderColor: "hsl(43 75% 49% / 0.3)" }}>
              ...
              <AccordionContent className="px-4 sm:px-6">
                <p className="text-base text-muted-foreground mb-4">{t("int.c4.desc")}</p>
                ...
                {[
                  ...
                  <div key={lvl.level} className="mb-4">
                    <p className="text-sm font-bold text-gold mb-2 uppercase tracking-wide">{lvl.level}</p>
                ...
                <div className="bg-muted/30 rounded-sm p-3 mb-3">
                  <p className="text-sm font-bold mb-2">{t("int.c4.proof.title")}</p>
                  <p className="text-sm text-muted-foreground mb-2">{t("int.c4.storie.rules")}</p>
                  <p className="text-sm text-muted-foreground">{t("int.c4.depo.rules")}</p>
                </div>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
      ...
      <section className="section-dark py-12 sm:py-20 px-3 sm:px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            ...
            <div className="gold-divider mx-auto mb-6" />
            <p className="text-base mb-4" style={{ color: "hsl(0 0% 70%)" }}>{t("int.b5.desc")}</p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mb-6">
            {[t("int.b5.ex1"), t("int.b5.ex2"), t("int.b5.ex3"), t("int.b5.ex4"), t("int.b5.ex5")].map((ex) => (
              <div key={ex} className="prize-card py-3 px-3">
                ...
                <p className="text-sm font-bold text-center" style={{ color: "hsl(0 0% 85%)" }}>{ex}</p>
              </div>
            ))}
          </div>

          <p className="text-sm mb-8" style={{ color: "hsl(0 0% 50%)" }}>{t("int.b5.rules")}</p>
          ...
          <div className="border rounded-sm p-6" style={{ borderColor: "hsl(43 75% 49% / 0.3)" }}>
            ...
            <p className="text-sm mb-3" style={{ color: "hsl(0 0% 70%)" }}>{t("int.b5.ambassador.desc")}</p>
            <p className="text-sm font-bold text-gold mb-2">{t("int.b5.ambassador.fox")}</p>
            <p className="text-sm mb-3" style={{ color: "hsl(0 0% 60%)" }}>{t("int.b5.ambassador.fox.desc")}</p>
            <p className="text-sm mb-3" style={{ color: "hsl(0 0% 60%)" }}>{t("int.b5.ambassador.how")}</p>
            <p className="text-sm mb-3" style={{ color: "hsl(0 0% 60%)" }}>{t("int.b5.ambassador.proof")}</p>
            <p className="text-sm font-bold mb-2" style={{ color: "hsl(0 0% 85%)" }}>{t("int.b5.ambassador.sales")}</p>
            <div className="bg-muted/10 rounded-sm p-3 mt-3">
              <p className="text-sm font-bold text-gold">{t("int.b5.ambassador.important")}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-20 px-3 sm:px-4 bg-background">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            ...
            <div className="gold-divider mx-auto mb-4" />
            <p className="text-base text-muted-foreground mb-2">{t("int.b6.intro")}</p>
            <a href="#" className="text-gold text-base font-bold underline">{t("int.b6.regulation")}</a>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="border border-border rounded-sm p-5" style={{ borderColor: "hsl(43 75% 49% / 0.2)" }}>
              ...
              <p className="text-sm text-muted-foreground mb-1">{t("int.b6.period.start")}</p>
              <p className="text-sm text-muted-foreground">{t("int.b6.period.end")}</p>
            </div>
            ...
            <div className="border border-border rounded-sm p-5" style={{ borderColor: "hsl(43 75% 49% / 0.2)" }}>
              ...
              <p className="text-sm text-muted-foreground">{t("int.b6.bmw.desc")}</p>
            </div>
            ...
            <div className="border border-border rounded-sm p-5" style={{ borderColor: "hsl(43 75% 49% / 0.2)" }}>
              ...
              <p className="text-sm text-muted-foreground mb-2">{t("int.b6.who.desc")}</p>
              ...
              <p className="text-sm text-muted-foreground">{t("int.b6.who.note")}</p>
            </div>
            ...
            <div className="border border-border rounded-sm p-5" style={{ borderColor: "hsl(43 75% 49% / 0.2)" }}>
              ...
              <p className="text-sm text-muted-foreground mb-2">{t("int.b6.integrity.desc")}</p>
              <p className="text-sm font-bold mb-1">{t("int.b6.integrity.prohibited")}</p>
              <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside mb-2">
                <li>{t("int.b6.integrity.p1")}</li>
                <li>{t("int.b6.integrity.p2")}</li>
                <li>{t("int.b6.integrity.p3")}</li>
              </ul>
              <p className="text-sm text-destructive font-bold">{t("int.b6.integrity.penalty")}</p>
            </div>
            ...
            <div className="border border-border rounded-sm p-5" style={{ borderColor: "hsl(43 75% 49% / 0.2)" }}>
              ...
              <p className="text-sm text-muted-foreground mb-1">{t("int.b6.adjust.desc")}</p>
              <p className="text-sm text-muted-foreground">{t("int.b6.adjust.note")}</p>
            </div>
            ...
            <div className="border-2 rounded-sm p-6 text-center" style={{ borderColor: "hsl(43 75% 49% / 0.5)", background: "hsl(43 75% 49% / 0.05)" }}>
              ...
              <p className="font-body text-lg font-bold mb-1">{t("int.b6.final.desc")}</p>
              <p className="text-gold font-black text-base uppercase tracking-widest">{t("int.b6.final.motto")}</p>
            </div>
          </div>
        </div>
      </section>
